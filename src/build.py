...
T = {
    "en": {
        ...
        "blog_about_text": 'A custom static site engine built from scratch in Python — Markdown + YAML frontmatter pipeline, bilingual i18n with clean URL routing, WordPress Cenote–inspired theme. The AI chat agent is powered by DeepSeek with SSE streaming and CloudBase persistence, all hand-wired. Over 140 technical articles.<br>Technical notes, project retrospectives, industry observations. Quality over frequency.',
    ...
    "zh": {
        ...
        "blog_about_text": "从零构建的静态博客引擎：Python 驱动的 Markdown + YAML frontmatter 构建管线，中英双语 i18n 与干净 URL 路由，WordPress Cenote 风格主题。AI 聊天助手基于 DeepSeek API + SSE 流式输出 + CloudBase 持久化，系统提示词 180+ 行手工调校。140+ 篇技术文章。<br>写技术笔记、项目复盘、行业观察。不追求日更，追求每篇都值得读。",
        "flight_hours": "累计飞行时长",
        "flight_km": "累计飞行里程",

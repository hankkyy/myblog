...
T = {
    "en": {
        ...
        "blog_about_text": 'A custom static site engine built from scratch in Python — Markdown + YAML frontmatter pipeline, bilingual i18n with clean URL routing, WordPress Cenote–inspired theme. The AI digital avatar enables asynchronous connection — even when I\'m offline, visitors can learn about my experience, projects, and technical perspectives through natural conversation. It\'s also an exploration of personality-driven AI agents: one that knows when to joke, when to be serious, and when to say "I don\'t know." Over 140 technical articles.<br>Technical notes, project retrospectives, industry observations.',
    ...
    "zh": {
        ...
        "blog_about_text": "从零构建的静态博客引擎：Python 驱动的 Markdown + YAML frontmatter 构建管线，中英双语 i18n 与干净 URL 路由，WordPress Cenote 风格主题。通过 AI 数字分身实现异步社交——不在线的时候，访客也能了解我的经历、项目和技术观点，每一轮对话都是个性化的了解过程。用 AI Agent 探索人格化对话的边界——一个懂分寸、有性格的数字分身，知道什么时候开玩笑、什么时候认真，什么时候该说「我不知道」。140+ 篇技术文章。<br>写技术笔记、项目复盘、行业观察。",
        "flight_hours": "累计飞行时长",
        "flight_km": "累计飞行里程",

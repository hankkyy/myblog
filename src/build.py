...
T = {
    ...
    "zh": {
        ...
        "blog_about_text": "从零构建的静态博客引擎：Python 驱动的 Markdown + YAML frontmatter 构建管线，中英双语 i18n 与干净 URL 路由，WordPress Cenote 风格主题。AI 聊天助手基于 DeepSeek V4-pro 大模型，SSE 流式输出、三层门控 Prompt 架构，亚洲节点使用 CloudBase 腾讯云持久化，全球节点通过 Vercel 部署。140+ 篇技术文章。<br>写技术笔记、项目复盘、行业观察。不追求日更，追求每篇都值得读。",
        "flight_hours": "累计飞行时长",
        "flight_km": "累计飞行里程",

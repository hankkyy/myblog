...
.profile-card-header{{padding:18px 20px;cursor:pointer;user-select:none;background:#fff;transition:background .15s;display:flex;flex-direction:column}}
...
.profile-chevron{{transition:transform .2s;font-size:12px;color:#9ca3af;align-self:flex-end;margin-top:-20px}}
...
#admin-profiles-toolbar{{display:none;padding:0 0 16px 0;gap:10px;flex-wrap:wrap}}
...
<div id="admin-overlay">
  <div id="admin-panel">
    ...
    <div id="admin-tabs" style="display:none;display:flex;gap:0;border-bottom:1px solid #dee2e6">

...
def build():
    ...
    def pagination_html(current_page):
        ...
        jump_input += f'<input type="number" min="1" max="{total_pages}" placeholder="跳转" id="jump-input-{current_page}" style="width:50px;text-align:center;border:1px solid #dee2e6;border-right:none;border-radius:4px 0 0 4px;padding:5px 4px;font-size:.85rem;line-height:1.4;outline:none;color:#363b40;transition:border-color .2s" onfocus="this.style.borderColor=&#39;#146bb7&#39;" onblur="this.style.borderColor=&#39;#dee2e6&#39;">'

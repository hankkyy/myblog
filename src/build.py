...
def build():
    ...
    def pagination_html(current_page):
        ...
        jump_input += f'<input type="number" min="1" max="{total_pages}" placeholder="" id="jump-input-{current_page}" style="width:48px;text-align:center;border:1px solid #e9ecef;border-radius:4px 0 0 4px;padding:4px 0;font-size:.9rem;outline:none">'

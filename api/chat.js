...
My name is Zihao Zhang — people also call me Hank. The nickname 可乐 (Cola/Coke) came from grandparents who couldn't pronounce "Hank" — they'd just say the last sound "k" (可, kě), which turned into 可乐 (kělè), and then everyone just started calling me that. I'm from Hubei, China（湖北）. I was born on September 24, 2003, which makes me a Libra, an air sign, and my MBTI is ENFP. I think both capture something true about me: I'm drawn to people, to new ideas, and to the spaces in between — between places, between cultures, between who I am and who I'm becoming.
